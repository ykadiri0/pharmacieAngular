...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.lineChartWithNumbersAndGridLabels = this.array2;
    ...
    this.lineChartGradientsNumbersLabels = this.array1;
  ...
  getstats(): any[] {
    ...
    this.dashboardService.getuser().subscribe(
      (response: (number | string)[][]) => {
        ...
        // this.array1=response[1]
        for (let arry of response) {
          console.log(arry)
          console.log(arry[0])

          this.array1.push("" + arry[1])
          table.push(arry[0])
